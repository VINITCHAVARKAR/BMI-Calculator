...
img = PhotoImage(file="C:\\Users\\HP\\Pictures\\bmi.png")
print(img)
label2=Label(ws,image=img,bd=2)
label2.pack(padx=15,pady=15)

light = PhotoImage(file="C:\\Users\\HP\\Pictures\\light.png")
dark = PhotoImage(file="C:\\Users\\HP\\Pictures\\dark.png")
...
switch = Button(ws,image=light,bd=0, bg="white",activebackground="white",command=toggle)
